...
from PyUtils import Process, UnitTester, Random
...
class ProcessTests(unittest.TestCase):
   ...
   @patch('PyUtils.Process.bytes_to_utf8', spec_set=True)
   ...
   @patch('builtins.print', spec_set=True)
   @patch('PyUtils.Process.cross_platform_subprocess_call', spec_set=True)
   ...
   @patch('PyUtils.Process.append_args', spec_set=True)
   ...
   def run_and_check_stdout_for_substring_test(self):
      @patch('builtins.print', spec_set=True)
      @patch('PyUtils.Process.run_and_get_stdout', spec_set=True)
      @patch('sys.exit', spec_set=True)
