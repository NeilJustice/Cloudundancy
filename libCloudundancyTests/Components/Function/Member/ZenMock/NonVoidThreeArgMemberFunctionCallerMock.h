...
public:
   ...
   ZENMOCK_NONVOID5_CONST(ReturnType, ConstCall, const ClassType*, ConstMemberFunctionType, Arg1Type, Arg2Type, Arg3Type)

   using NonConstMemberFunctionType = ReturnType(ClassType::*)(Arg1Type, Arg2Type, Arg3Type);
   ZENMOCK_NONVOID5_CONST(ReturnType, NonConstCall, ClassType*, NonConstMemberFunctionType, Arg1Type, Arg2Type, Arg3Type)
};
