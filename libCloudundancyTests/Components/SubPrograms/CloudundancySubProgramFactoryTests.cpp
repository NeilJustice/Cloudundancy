...
AFACT(NewCloudundancySubProgram_ProgramModeIsCopyFileToFilesAndFoldersToMultipleFolder_ReturnsMakeSharedCopyFileToFilesToMultipleFoldersSubProgram)
AFACT(NewCloudundancySubProgram_ProgramModeIsCopyFileToFilesAndFoldersToMultipleFolderTo7ZipFile_ReturnsMakeSharedSevenZipSubProgram)
...
TEST(NewCloudundancySubProgram_ProgramModeIsCopyFileToFilesAndFoldersToMultipleFolderTo7ZipFile_ReturnsMakeSharedSevenZipSubProgram)
{
   const shared_ptr<CloudundancySubProgram> cloudundancySubProgram =
