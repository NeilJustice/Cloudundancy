...
//{
//   _fileSystemMock->AppendTimestampedTextMock.Expect();
...
//   METALMOCK(_fileSystemMock->AppendTimestampedTextMock.CalledOnceWith(
//      expectedCloudundancyLogFilePath, "Cloudundancy backup started"));
//}
//
