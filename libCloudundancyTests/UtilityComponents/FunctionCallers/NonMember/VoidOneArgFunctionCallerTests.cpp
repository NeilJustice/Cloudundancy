#include "pch.h"
#include "libCloudundancy/UtilityComponents/FunctionCallers/NonMember/VoidOneArgFunctionCaller.h"
...
{
   Utils::VoidOneArgFunctionCaller<ArgType> voidOneArgFunctionCaller{};
