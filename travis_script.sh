...
curl https://raw.githubusercontent.com/NeilJustice/ZenUnitAndMetalMock/main/ZenUnitAndMetalMock/ZenUnit.h --create-dirs -o "$TRAVIS_BUILD_DIR/ZenUnit/ZenUnit.h"
curl https://raw.githubusercontent.com/NeilJustice/ZenUnitAndMetalMock/main/ZenUnitAndMetalMock/MetalMock.h --create-dirs -o "$TRAVIS_BUILD_DIR/ZenUnit/MetalMock.h"
...
./libCloudundancyTests/libCloudundancyTests --test-runs=5 --random --exit-1-if-tests-skipped
